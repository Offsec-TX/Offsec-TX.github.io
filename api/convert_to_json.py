...
def convert_files_to_json(folder_paths, output_json_path):
    all_json_data = []
...
if __name__ == "__main__":
    folder_paths = ['./../_testcases', './../_wadcoms']  # process both folders
    output_json_path = './redcoms.json'

    convert_files_to_json(folder_paths, output_json_path)
